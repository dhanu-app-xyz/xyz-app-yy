...
router.post("/register",
    ...
    body("name")
        ...
        .withMessage("name lenght 3 and 25 characters"), 
    ...
    body("password").notEmpty().withMessage("please fill password field!")
        .isLength({ min: 5, max: 20 }).withMessage("password length invalid"),
